          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                axios.post('http://127.0.0.1:8000/api/auth/register', _this.form).then(function (res) {
                  _this.massegeSuccess = res.data.message;
                  setTimeout(function () {
                    _this.$router.push({
                      name: "Login"
                    });
      ...
      [
        ...
        _c("div", { staticClass: "form-group" }, [
          _c("input", {
            ...
            staticClass: "form-control  m-2",
            attrs: { type: "text", name: "phone_number", placeholder: "Phone" },
        ...
        _c("div", { staticClass: "form-group " }, [
          _c("input", {
            ...
            domProps: { checked: _vm._q(_vm.form.gender, "M") },
            on: {
              change: function($event) {
                return _vm.$set(_vm.form, "gender", "M")
              }
            }
          }),
          ...
          _c("input", {
            ...
            domProps: { checked: _vm._q(_vm.form.gender, "F") },
            on: {
              change: function($event) {
                return _vm.$set(_vm.form, "gender", "F")
              }
            }
          }),
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "text-center" }, [
      _c(
        "button",
        { staticClass: "btn btn-success  w-25 ", attrs: { type: "submit" } },
        [_vm._v("\n                Register\n            ")]
      )
    ])
  }
